...
public final class F64Trunc extends PlainNumeric implements ProcessedInstruction {
    public static final F64Trunc INSTANCE = new F64Trunc();

    private F64Trunc() {
        super("f64.trunc", (byte) 0x9D);
    }
