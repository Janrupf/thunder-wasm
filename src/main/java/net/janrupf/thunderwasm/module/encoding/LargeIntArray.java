...
public class LargeIntArray {
     ...
     */
    public LargeIntArray(LargeArrayIndex length) {
        ...
        for (int i = 0; i < arrayCount - 1; i++) {
            this.data[i] = new int[Integer.MAX_VALUE];
        }

        this.data[arrayCount - 1] = new int[lastArraySize];
    }
     ...
     */
    public int get(LargeArrayIndex index) {
        try {
     ...
     */
    public void set(LargeArrayIndex index, int value) {
        try {
     ...
     */
    public void setRegion(LargeArrayIndex index, int[] region) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LargeIntArray)) return false;
        LargeIntArray that = (LargeIntArray) o;
